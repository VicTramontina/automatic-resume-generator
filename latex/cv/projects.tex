...
%---------------------------------------------------------
  \cventry
    {Universidade Federal do Rio Grande do Sul} % Organisation
  ...
  \cventry
    ...
    {Nov 2021 - Dec 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of project
        ...
        \item {Finding the differences between the best teams and players in various fields and their performance on the field and the opponents.}
